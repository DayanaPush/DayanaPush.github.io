(() => {
    ...
    function initSliders() {
        if (document.querySelector(".reviews__slider")) {
            ...
            new swiper_core_Swiper(".education__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    prevEl: ".education__arrow-left",
                    nextEl: ".education__arrow-right"
                },
                on: {}
            });
        }
...
***************************************************************************** */
    ...
    da.init();
    function initMarquee(animationSpeed = 1) {
        const marqueeContainer = document.querySelector(".footer__marquee");
        const marqueeElements = document.querySelectorAll(".footer__stroke");
